...
This repo contains instruction and files for Week 6 assignments. 
...
1. Review the instructions for this lab provided in the [06_Instructor_Lab.md](/06_Instructor_Lab.md) file
...
1. Review the instructions for this lab provided in the [06_Independent_Lab.md](/06_Independent_Lab.md) file
2. In JupyterLab, create a new Python notebook
  * Python 3 (ipykernal)
3. Name your notebook according to naming convention specified in Canvas
